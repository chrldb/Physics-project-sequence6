...
def draw_control_panel_header(screen, header_font, sub_header_font):
    ...
    header = header_font.render("Harmonic Properties", True, Colors.white)
    header_surface.blit(header, (0.05 * control_rectangle_width, 0.1 * control_panels_header_height))

    sub_header_font = sub_header_font.render("Harmonic Superposition", True, Colors.white)
...
def main():
    ...
    pg.init()
    pg.display.set_caption('Standing Wave in a String')
